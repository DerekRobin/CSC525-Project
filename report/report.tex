...
Finding the Alu domain of BC200 and its homologs (see appendix \derek{add which appendix sections}), we concluded that the Alu domain between human BC200 and its Selected homologs are nearly identical. So, their function in brain may be same with each other. 
...
\derek{Reference the proper appendix section for alignment}
...
The result of the multiple sequence alignment can be found in Appendix \ref{app:one}
